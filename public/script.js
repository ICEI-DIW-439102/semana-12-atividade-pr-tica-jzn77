...
// ================================================================
let estado = {
  tipo:   'popular',   // categoria atual
  busca:  '',          // termo pesquisado
...
function renderPaginacao() {
  ...
  const max = Math.min(estado.total, 500); // TMDB limita 500 páginas
  ...
  // Gera até 5 botões de página em torno da atual
  const paginas = [];
